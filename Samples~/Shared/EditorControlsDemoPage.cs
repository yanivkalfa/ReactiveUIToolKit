...
namespace ReactiveUITK.Samples.Shared
{
    public static class EditorControlsDemoPage
    {
        ...
        {
            string search =
                props != null && props.TryGetValue("search", out var s)
                    ? s as string
                    : string.Empty;
            UnityEngine.Object sel =
                props != null && props.TryGetValue("sel", out var o)
                ...
                V.ScrollView(
                    ...
                    V.VisualElement(
                        ...
                        V.VisualElement(
                            ...
                            V.VisualElement(
                                new Style { { StyleKeys.FlexGrow, 1f } },
                                key: "rhs",
                        ...
                        V.TwoPaneSplitView(
                            ...
                            V.VisualElement(
                                new Style { { StyleKeys.FlexGrow, 1f }, { StyleKeys.Padding, 6f } },
                                key: "pane2",
