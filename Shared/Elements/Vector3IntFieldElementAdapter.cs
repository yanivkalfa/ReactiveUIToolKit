...
namespace ReactiveUITK.Elements
{
    public sealed class Vector3IntFieldElementAdapter : BaseElementAdapter
    {
        ...
        private static void ApplySlots(BaseField<Vector3Int> field, IReadOnlyDictionary<string, object> properties)
        {
        ...
        private static void ApplySlotsDiff(BaseField<Vector3Int> field, IReadOnlyDictionary<string, object> previous, IReadOnlyDictionary<string, object> next)
        {
            previous ??= new Dictionary<string, object>();
            next ??= new Dictionary<string, object>();
