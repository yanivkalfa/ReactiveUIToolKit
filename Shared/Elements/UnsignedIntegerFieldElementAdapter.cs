...
namespace ReactiveUITK.Elements
{
    public sealed class UnsignedIntegerFieldElementAdapter : BaseElementAdapter
    {
        ...
        private static void ApplySlots(UnsignedIntegerField field, IReadOnlyDictionary<string, object> properties)
        {
        ...
        private static void ApplySlotsDiff(UnsignedIntegerField field, IReadOnlyDictionary<string, object> previous, IReadOnlyDictionary<string, object> next)
        {
            previous ??= new Dictionary<string, object>();
            next ??= new Dictionary<string, object>();
