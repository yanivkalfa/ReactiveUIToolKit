...
namespace ReactiveUITK.Elements
{
    public sealed class ColorFieldElementAdapter : BaseElementAdapter
    {
        ...
        private static void ApplySlots(ColorField field, IReadOnlyDictionary<string, object> properties)
        {
        ...
        private static void ApplySlotsDiff(ColorField field, IReadOnlyDictionary<string, object> previous, IReadOnlyDictionary<string, object> next)
        {
            previous ??= new Dictionary<string, object>();
            next ??= new Dictionary<string, object>();
