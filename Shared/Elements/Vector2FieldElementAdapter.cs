...
namespace ReactiveUITK.Elements
{
    public sealed class Vector2FieldElementAdapter : BaseElementAdapter
    {
        ...
        private static void ApplySlots(Vector2Field field, IReadOnlyDictionary<string, object> properties)
        {
        ...
        private static void ApplySlotsDiff(Vector2Field field, IReadOnlyDictionary<string, object> previous, IReadOnlyDictionary<string, object> next)
        {
            previous ??= new Dictionary<string, object>();
            next ??= new Dictionary<string, object>();
