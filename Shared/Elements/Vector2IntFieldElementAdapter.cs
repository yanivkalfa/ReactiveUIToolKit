...
namespace ReactiveUITK.Elements
{
    public sealed class Vector2IntFieldElementAdapter : BaseElementAdapter
    {
        ...
        private static void ApplySlots(BaseField<Vector2Int> field, IReadOnlyDictionary<string, object> properties)
        {
        ...
        private static void ApplySlotsDiff(BaseField<Vector2Int> field, IReadOnlyDictionary<string, object> previous, IReadOnlyDictionary<string, object> next)
        {
            previous ??= new Dictionary<string, object>();
            next ??= new Dictionary<string, object>();
