...
namespace ReactiveUITK.Elements
{
    public sealed class RadioButtonElementAdapter : BaseElementAdapter
    {
        ...
        public override void ApplyProperties(VisualElement element, IReadOnlyDictionary<string, object> properties)
        {
            ...
            {
                TryApplyProp<string>(properties, "text", value => { radioButtonElement.text = value ?? string.Empty; });
                TryApplyProp<bool>(properties, "value", value => { radioButtonElement.value = value; });
        ...
        private static void ApplySlots(RadioButton radioButtonElement, IReadOnlyDictionary<string, object> properties)
        {
            ApplySlot(radioButtonElement, properties, "label");
        }

        private static void DiffSlot(RadioButton radioButtonElement, IReadOnlyDictionary<string, object> previous, IReadOnlyDictionary<string, object> next, string slotKey)
        {
        ...
        private static void ApplySlot(RadioButton radioButtonElement, IReadOnlyDictionary<string, object> properties, string slotKey)
        {
            if (properties == null)
            {
                return;
        ...
        private static VisualElement ResolveSlotElement(RadioButton radioButtonElement, string slotKey)
        {
