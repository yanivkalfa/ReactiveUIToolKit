...
namespace ReactiveUITK.Elements
{
    public sealed class UnsignedLongFieldElementAdapter : BaseElementAdapter
    {
        ...
        private static void ApplySlots(UnsignedLongField field, IReadOnlyDictionary<string, object> properties)
        {
        ...
        private static void ApplySlotsDiff(UnsignedLongField field, IReadOnlyDictionary<string, object> previous, IReadOnlyDictionary<string, object> next)
        {
            previous ??= new Dictionary<string, object>();
            next ??= new Dictionary<string, object>();
