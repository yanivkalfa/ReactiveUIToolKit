...
namespace ReactiveUITK.Elements
{
    public sealed class Hash128FieldElementAdapter : BaseElementAdapter
    {
        ...
        private static void ApplySlots(BaseField<Hash128> field, IReadOnlyDictionary<string, object> properties)
        {
        ...
        private static void ApplySlotsDiff(BaseField<Hash128> field, IReadOnlyDictionary<string, object> previous, IReadOnlyDictionary<string, object> next)
        {
            previous ??= new Dictionary<string, object>();
            next ??= new Dictionary<string, object>();
