...
namespace ReactiveUITK.Elements
{
    public sealed class Vector3FieldElementAdapter : BaseElementAdapter
    {
        ...
        private static void ApplySlots(Vector3Field field, IReadOnlyDictionary<string, object> properties)
        {
        ...
        private static void ApplySlotsDiff(Vector3Field field, IReadOnlyDictionary<string, object> previous, IReadOnlyDictionary<string, object> next)
        {
            previous ??= new Dictionary<string, object>();
            next ??= new Dictionary<string, object>();
