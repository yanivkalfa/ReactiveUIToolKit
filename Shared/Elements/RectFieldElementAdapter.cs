...
namespace ReactiveUITK.Elements
{
    public sealed class RectFieldElementAdapter : BaseElementAdapter
    {
        ...
        private static void ApplySlots(BaseField<Rect> field, IReadOnlyDictionary<string, object> properties)
        {
        ...
        private static void ApplySlotsDiff(BaseField<Rect> field, IReadOnlyDictionary<string, object> previous, IReadOnlyDictionary<string, object> next)
        {
            previous ??= new Dictionary<string, object>();
            next ??= new Dictionary<string, object>();
