...
namespace ReactiveUITK.Elements
{
    public sealed class RectIntFieldElementAdapter : BaseElementAdapter
    {
        ...
        private static void ApplySlots(BaseField<RectInt> field, IReadOnlyDictionary<string, object> properties)
        {
        ...
        private static void ApplySlotsDiff(BaseField<RectInt> field, IReadOnlyDictionary<string, object> previous, IReadOnlyDictionary<string, object> next)
        {
            previous ??= new Dictionary<string, object>();
            next ??= new Dictionary<string, object>();
