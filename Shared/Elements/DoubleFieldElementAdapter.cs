...
namespace ReactiveUITK.Elements
{
    public sealed class DoubleFieldElementAdapter : BaseElementAdapter
    {
        ...
        private static void ApplySlots(DoubleField field, IReadOnlyDictionary<string, object> properties)
        {
        ...
        private static void ApplySlotsDiff(DoubleField field, IReadOnlyDictionary<string, object> previous, IReadOnlyDictionary<string, object> next)
        {
            previous ??= new Dictionary<string, object>();
            next ??= new Dictionary<string, object>();
