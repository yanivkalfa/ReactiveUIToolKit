...
namespace ReactiveUITK.Core
{
    internal sealed class NodeMetadata
    {
        ...
        public List<(Func<Action> factory, object[] deps, object[] lastDeps, Action cleanup)> FunctionEffects;
        public List<(Func<Action> factory, object[] deps, object[] lastDeps, Action cleanup)> FunctionLayoutEffects;
