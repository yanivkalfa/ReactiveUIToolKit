...
// LSP-side mirror of the SG's UitkxPipeline.IsOwnedByCompilation /
...
// path contains an Editor/ segment. Identical contract to the SG; covered
// by AsmdefResolverParityTests in the SG suite.
//
// Cache is keyed by directory (not file path) so a folder of files pays the
// walk cost once. Invalidated by WorkspaceIndex when an .asmdef file is
