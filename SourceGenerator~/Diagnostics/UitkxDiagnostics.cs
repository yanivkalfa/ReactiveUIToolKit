...
namespace ReactiveUITK.SourceGenerator
{
    ...
    ///   UITKX0020       ref={} on user component with no MutableRef param
    ///   UITKX0021       ref={} on user component with multiple MutableRef params (ambiguous)
    ...
    internal static class UitkxDiagnostics
    {
        ...
        /// <c>Hooks.MutableRef&lt;T&gt;</c> parameter, so the ref cannot be routed.
        /// </summary>
        public static readonly DiagnosticDescriptor RefOnComponentWithNoRefParam = new DiagnosticDescriptor(
            id: "UITKX0020",
            title: "ref attribute on component with no MutableRef parameter",
            messageFormat: "Component '{0}' does not declare a 'Hooks.MutableRef<T>' parameter. "
                + "Remove 'ref={{...}}' or add a 'Hooks.MutableRef<T>?' parameter to the component.",
            category: Category,
            defaultSeverity: DiagnosticSeverity.Error,
            isEnabledByDefault: true,
            description: """
                The ref-as-prop pattern requires the target component to accept a
                Hooks.MutableRef<T> parameter so the emitter knows which prop to populate.
        ...
        /// <c>Hooks.MutableRef&lt;T&gt;</c> parameters; the emitter cannot determine which one to
        /// populate without an explicit prop name.
        /// </summary>
        public static readonly DiagnosticDescriptor RefOnComponentWithAmbiguousRefParam = new DiagnosticDescriptor(
            id: "UITKX0021",
            title: "ref attribute is ambiguous — component has multiple MutableRef parameters",
            messageFormat: "Component '{0}' declares multiple 'Hooks.MutableRef<T>' parameters. "
            ...
            description: """
                ...
                Hooks.MutableRef<T> parameter.  When multiple MutableRef parameters exist, pass
