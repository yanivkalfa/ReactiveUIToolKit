...
export component PlayerCard(PlayerInfo player) {
...
namespace MyGame.UI                    // ← @namespace (else path-derived)
{
...
// The same-named companion modules (module PlayerCard) merge into this same
// partial class — so their members are reachable directly, no import needed.`
